  ...
  const approachPoints = [
    {
      ...
      desc: "Developed a core visual library that allowed for rapid iteration.",
    },
    {
      title: "AI-Powered Versioning",
      desc: "Used our engine to generate 100+ variations from single creative concepts.",
    },
    {
      title: "Direct Pipeline Integration",
      desc: "Connected directly to their product feed for real-time asset updates.",
    },
  ];
        ...
        <Container>
          <div className="max-w-3xl mb-12">
            ...
            <p className="font-sans text-xl text-white/60 leading-relaxed">
              Achieving massive creative scale without expanding the internal
              team.
            </p>
          </div>
        </Container>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 font-sans text-white/60 leading-relaxed">
                <p>
                  As the brand expanded into new global markets, the demand for
                  localized, platform-specific creative assets outpaced their
                  internal production capacity.
                </p>

                <p>
                  The team was spending 70% of their time on resizing and minor
                  variations rather than high-level creative strategy, leading
                  to burnout and missed launch windows.
                </p>
              </div>
            </div>
      ...
      <Section className="py-24 border-y border-white/10">
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            <span className="text-[10px] font-bold tracking-widest uppercase text-white/30 mb-4 block">
              Resulting Outcome
            </span>

            <div className="mb-4">
              <span className="text-6xl md:text-8xl font-display font-semibold text-white block">
                10× Output
              </span>
            </div>
        ...
        <Container>
          <div className="mb-12">
            ...
            <p className="font-sans text-white/50">
              A look at the modular asset system developed for this campaign.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative p-12 rounded-3xl bg-white/5 border border-white/10 overflow-hidden">
              ...
              <p className="font-display text-2xl text-white italic mb-8 leading-relaxed">
                "[Placeholder for approved client testimonial quote. This
                section will feature a quote from the lead stakeholder
                regarding the impact on their workflow and ROI.]"
              </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-sans text-sm text-white/40">
                    [Stakeholder Role], [Client Company]
                  </p>
                </div>
              </div>
            </div>
