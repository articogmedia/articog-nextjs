        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="font-sans text-xl text-white/60 leading-relaxed">
              High-volume static ad creative for paid social and display. We
              help you scale your performance marketing with on-brand visuals
        ...
        <Container>
          <div className="mb-12">
            ...
            <p className="font-sans text-white/50 max-w-2xl">
              Professional-grade static creative designed for modern
