        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="font-sans text-xl text-white/60 leading-relaxed">
              Traditional agencies do great work, but the model has real
              constraints at modern scale and speed. Here is how Articog&apos;s
              engine compares to the legacy approach.
            </p>
          </div>
        </Container>
      </Section>
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="font-display text-4xl font-semibold text-white mb-8">
              Experience the Articog advantage
            </h2>
