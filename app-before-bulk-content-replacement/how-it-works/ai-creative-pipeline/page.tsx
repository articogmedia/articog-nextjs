        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="font-sans text-xl text-white/60 leading-relaxed">
              A deep look at what happens between your brief and the final
              delivery. Our pipeline combines state-of-the-art AI with expert
              human oversight.
            </p>
          </div>
        </Container>
        ...
        <Container>
          <div className="mb-12">
            ...
            <p className="font-sans text-white/50 max-w-2xl">
              A technical overview of our production engine, built for scale
              and precision.
            </p>
          </div>
        ...
        <Container>
          <div className="p-8 md:p-12 rounded-2xl bg-white/5 border border-white/10 max-w-4xl">
            ...
            <p className="font-sans text-white/70 leading-relaxed max-w-2xl">
              It's important to note that the AI Creative Pipeline is not
              one-size-fits-all. Every pipeline is calibrated per-brand,
              incorporating your unique visual assets, tone of voice, and
              industry-specific requirements to ensure every output is
              unmistakably yours.
            </p>
          </div>
        </Container>
